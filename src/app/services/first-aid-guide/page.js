...
export default function FirstAidGuidePage() {
  ...
  const guides = useMemo(() => {
    const injuryGuides = allGuides.filter(
      (g) => g.category === "Common Injuries" || g.category === "Medical Emergencies"
    );
      ...
      <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        <div className="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p className="text-muted-foreground">First aid for cuts, choking, and more.</p>
            </div>
        </div>
