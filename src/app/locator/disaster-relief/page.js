...
export default function DisasterReliefPage() {
  ...
  const disasterLocations = emergencyLocations.filter(l => l.type === 'disaster');
  ...
  const handleSearch = (event) => {
    ...
    if (term) {
      ...
      setFilteredLocations(disasterLocations);
    }
  };
    ...
    if (locations.length === 0) {
      return (
        <p className="text-center text-muted-foreground mt-4">
          No disaster relief centers found.
        </p>
      );
    }
    return (
    ...
    <div>
      <div className="mt-8 mb-6">
        <div className="relative">
          ...
          <Input
            type="search"
            placeholder="Search for a disaster relief center..."
