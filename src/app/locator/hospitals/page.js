...
export default function HospitalsPage() {
  ...
  const hospitals = useMemo(() => {
    const allHospitals = emergencyLocations.filter((l) => l.type === "hospital");
    if (!searchTerm) return allHospitals;
      ...
      <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        <div className="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p className="text-muted-foreground">Find nearby medical centers and hospitals.</p>
            </div>
        </div>
        ...
        <section className="mt-8">
          {hospitals.length > 0 ? (
            ...
            <p className="text-center text-muted-foreground mt-12">
              No hospitals found for your search term.
            </p>
          )}
        </section>
      </main>
