...
import { ArrowLeft, Search, Hospital, MapPin } from "lucide-react";
...
export default function HospitalsPage() {
  ...
  const hospitalLocations = emergencyLocations.filter(l => l.type === 'hospital');
  const [filteredLocations, setFilteredLocations] = useState(hospitalLocations);
